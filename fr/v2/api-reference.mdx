...
<Note>
  **Nouveau dans v2.0** : Endpoint GraphQL disponible sur
...
```json
{
  ...
  "events": ["forecast.updated", "sensor.alert", "production.batch_completed"],
...
<Warning>
  **Données Sandbox** : L'environnement sandbox utilise des données de test et
  n'affecte pas votre compte de production.
</Warning>
