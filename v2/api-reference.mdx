...
<Note>
  {" "}
  **API Key**: Get your API key from the [Developer
  Settings](https://app.salsaasaservice.com/settings/api) in your dashboard.
</Note>
...
<Warning>
  **Sandbox Data**: The sandbox environment uses test data and doesn't affect
